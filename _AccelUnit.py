...
##### Instrumentation Counters
        self.add(pr.RemoteVariable(name = 'X16_cycles_arg', description = 'cycs', offset = 12, bitSize = 32, bitOffset = 0, mode = 'RO',))
        self.add(pr.RemoteVariable(name = 'X16_iters_arg', description = 'numiters', offset = 16, bitSize = 32, bitOffset = 0, mode = 'RO',))
        self.add(pr.RemoteVariable(name = 'X80_cycles_arg', description = 'cycs', offset = 20, bitSize = 32, bitOffset = 0, mode = 'RO',))
        self.add(pr.RemoteVariable(name = 'X80_iters_arg', description = 'numiters', offset = 24, bitSize = 32, bitOffset = 0, mode = 'RO',))
